...
const ChatLeadForm = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 md:bottom-4 right-4 z-[9998] flex flex-col items-end gap-2">
        <AnimatePresence>
          {bubbleVisible && !open && (
            <motion.div
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 md:bottom-4 right-4 z-[9999] w-[min(380px,calc(100vw-2rem))] rounded-3xl shadow-2xl overflow-hidden flex flex-col"
