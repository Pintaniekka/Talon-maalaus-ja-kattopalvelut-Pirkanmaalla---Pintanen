  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[1500px] overflow-hidden rounded-[2.5rem] bg-card shadow-2xl flex flex-col lg:flex-row">
        {/* Content Side */}
        <div className="relative z-10 w-full lg:w-2/3 p-8 md:p-14 lg:px-20 lg:py-24 xl:px-24 flex flex-col justify-center bg-card">
          ...
          <h1 className="heading-style max-w-3xl text-4xl md:text-5xl lg:text-6xl text-foreground leading-[1.1] mb-12 md:mb-16">
            Tiilikaton pinnoitus ja talon maalaus{" "}
            <span className="text-accent">Pirkanmaalla</span>
          </h1>

          <p className="hero-lead text-lg md:text-xl text-muted-foreground mb-16 md:mb-24 max-w-2xl leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-nowrap gap-4 sm:gap-8 mb-16 md:mb-24">
            <a
              href="/hinnat"
          ...
          {/* Trust row */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 gap-y-8 pt-12 border-t border-border">
