  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[1500px] overflow-hidden rounded-[2.5rem] bg-card shadow-2xl flex flex-col lg:flex-row">
        {/* Content Side */}
        <div className="relative z-10 w-full lg:w-2/3 p-8 md:p-14 lg:px-16 lg:py-20 xl:px-20 flex flex-col justify-center bg-card">
          ...
          <h1 className="heading-style max-w-3xl text-4xl md:text-5xl lg:text-6xl text-foreground leading-[1.1] mb-10 md:mb-12">
            Tiilikaton pinnoitus ja talon maalaus{" "}
            <span className="text-accent">Pirkanmaalla</span>
          </h1>

          <p className="hero-lead text-lg md:text-xl text-muted-foreground mb-14 md:mb-16 max-w-2xl leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-nowrap gap-4 sm:gap-6 mb-16 md:mb-20">
            <a
              href="/hinnat"
