    ...
    >
      <div className="relative w-full max-w-7xl overflow-hidden rounded-[2.5rem] bg-card shadow-2xl flex flex-col lg:flex-row">
        ...
        <div className="relative z-10 w-full lg:w-3/5 p-8 md:p-14 lg:p-20 flex flex-col justify-center bg-card">
          ...
          <h1 className="heading-style text-4xl md:text-5xl lg:text-6xl text-foreground leading-[1.08] mb-8 md:mb-10">
            Tiilikaton pinnoitus ja talon maalaus{" "}
            <span className="text-accent">Pirkanmaalla</span>
          </h1>

          <p className="hero-lead text-lg md:text-xl text-muted-foreground mb-12 md:mb-14 max-w-xl leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-5 mb-14 md:mb-16">
            <a
              href="/hinnat"
          ...
          {/* Trust row */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 gap-y-8 pt-8 border-t border-border">
