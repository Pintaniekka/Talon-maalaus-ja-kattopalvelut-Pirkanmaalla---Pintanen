  ...
  return (
    ...
    >
      <div className="relative w-full max-w-7xl overflow-hidden rounded-[2.5rem] bg-card shadow-2xl flex flex-col lg:flex-row">
        {/* Content Side */}
        <div className="relative z-10 w-full lg:w-3/5 p-8 md:p-16 lg:p-24 xl:p-28 flex flex-col justify-center bg-card">
          ...
          <h1 className="heading-style text-4xl md:text-5xl lg:text-6xl text-foreground leading-[1.15] mb-12 md:mb-16">
            Tiilikaton pinnoitus ja talon maalaus{" "}
            <span className="text-accent">Pirkanmaalla</span>
          </h1>

          <p className="hero-lead text-lg md:text-xl text-muted-foreground mb-20 md:mb-24 max-w-xl leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 mb-16 md:mb-24">
            <a
              href="/hinnat"
