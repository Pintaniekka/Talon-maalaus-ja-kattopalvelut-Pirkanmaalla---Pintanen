...
const KattopalvelutPinnoitus = () => {
  ...
  return <div>
      <SEO title="Tiilikaton pinnoitus Pirkanmaa – 5v takuu" description="Tiilikaton pinnoitus Pirkanmaalla huolellisella pohjatyöllä ja kestävällä maalauspinnoituksella. 5 vuoden takuu ja selkeä toteutus." />
