...
const TalonMaalaus = () => {
  const processSteps = [
    ...
    },
    {
      icon: Sun,
      title: "Pintamaalaus",
      description: "Laadukas kerros kestävää ulkomaalia suojaamaan pintoja.",
    },
    {
      icon: BadgeCheck,
      title: "Tarkastus",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Olemme erikoistuneet ulkomaalaukseen ja tiedämme, mitä laadukas työ vaatii. Huolellisesti tehdyt
                pohjatöt ovat avain pitkäikäiseen lopputulokseen.
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Tulemme mielellämme arvioimaan maalaustyön laajuuden ja antamaan tarjouksen. Arvio on aina maksuton eikä
                sido mihinkään.
              </p>
